...
import com.esmaeel.catchathief.ui.MainActivity
import com.esmaeel.getlearn.Utils.log

class EndlessService : Service() {
    private var powerListener: PowerListenerBroadcast =
        PowerListenerBroadcast()
    ...
    private fun createNotification(): Notification {
        ...
        return builder
            .setContentTitle(getString(R.string.catch_a_thief))
            .setContentText(getString(R.string.notification_instructions))
            .setContentIntent(pendingIntent)
            .setSmallIcon(R.mipmap.ic_launcher)
            .setTicker(getString(R.string.notification_instructions))
